...
<?= $this->section('page_title') ?>Modifier le mot de passe<?= $this->endSection() ?>
<?= $this->section('page_description') ?>Mettez à jour votre mot de passe pour sécuriser votre
compte<?= $this->endSection() ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input autocomplete="current-password" id="current_password" name="current_password"
                            type="password" required placeholder="Votre mot de passe actuel" class="w-full px-4 py-3 text-base border-2 rounded-lg appearance-none border-gray-300 bg-white 
                        ...
                        <button type="button" id="toggle-current-password"
                            aria-label="Afficher/masquer le mot de passe actuel" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-gray-700
                ...
                <div>
                    ...
                    <div class="relative">
                        <input autocomplete="new-password" id="password" name="password" type="password" required
                            placeholder="Votre nouveau mot de passe" class="w-full px-4 py-3 text-base border-2 rounded-lg appearance-none border-gray-300 bg-white 
                                   placeholder-gray-500 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20
                                   transition-colors duration-200 pr-12" />
                        <button type="button" id="toggle-password" aria-label="Afficher/masquer le nouveau mot de passe"
                ...
                <div>
                    ...
                    <div class="relative">
                        <input autocomplete="new-password" id="password-confirm" name="password_confirm" type="password"
                            required placeholder="Confirmer votre nouveau mot de passe" class="w-full px-4 py-3 text-base border-2 rounded-lg appearance-none border-gray-300 bg-white 
                                   placeholder-gray-500 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20
                                   transition-colors duration-200 pr-12" />
                        <button type="button" id="toggle-password-confirm"
                            aria-label="Afficher/masquer la confirmation du mot de passe" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-gray-700
                                   transition-colors duration-200">
                            <span class="material-symbols-outlined text-lg">
                                visibility_off
                            </span>
...
const setupToggle = (toggleButton, passwordField) => {
    toggleButton.addEventListener('click', () => {
        ...
        icon.setAttribute('aria-label', isPassword ? 'Masquer le mot de passe' :
